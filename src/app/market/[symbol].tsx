...
export default function MarketDetailScreen() {
  ...
  const openTrade = (side: Side, advanced = false) => {
    ...
    if (advanced) updateSetting('interfaceMode', 'advanced');
...
const styles = StyleSheet.create({
  header: { alignItems: 'center', borderBottomColor: colors.divider, borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: 'row', gap: 14, minHeight: 58, paddingHorizontal: 16 },
  identity: { alignItems: 'center', flex: 1, flexDirection: 'row', gap: 10 },
  symbol: { color: colors.text, fontSize: 14, fontWeight: '800' },
  name: { color: colors.textMuted, fontSize: 10, marginTop: 2 },
  content: { paddingBottom: 20 },
  lastLabel: { color: colors.textMuted, fontSize: 11, marginTop: 22, paddingHorizontal: 16 },
  price: { color: colors.text, fontFamily: typography.mono, fontSize: 32, fontWeight: '700', letterSpacing: -1, marginTop: 4, paddingHorizontal: 16 },
  change: { fontFamily: typography.mono, fontSize: 12, fontWeight: '700', marginTop: 6, paddingHorizontal: 16 },
  chart: { marginTop: 12 },
  timeframes: { borderBottomColor: colors.divider, borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: 'row', justifyContent: 'space-around', marginHorizontal: 16 },
  timeframe: { alignItems: 'center', minWidth: 44, paddingBottom: 11, paddingTop: 7 },
  timeframeText: { color: colors.textMuted, fontSize: 11, fontWeight: '600' },
  ...
  stats: { flexDirection: 'row', flexWrap: 'wrap', paddingHorizontal: 16, paddingTop: 22, rowGap: 18 },
  stat: { width: '50%' },
  statLabel: { color: colors.textMuted, fontSize: 11 },
  statValue: { color: colors.text, fontFamily: typography.mono, fontSize: 14, fontWeight: '600', marginTop: 5 },
  marketInfo: { borderTopColor: colors.divider, borderTopWidth: StyleSheet.hairlineWidth, marginTop: 24, paddingHorizontal: 16, paddingTop: 20 },
  infoTitle: { color: colors.text, fontSize: 17, fontWeight: '800', marginBottom: 9 },
  ...
  advancedLink: { alignItems: 'center', borderTopColor: colors.divider, borderTopWidth: StyleSheet.hairlineWidth, flexDirection: 'row', justifyContent: 'space-between', marginTop: 8, minHeight: 50 },
  advancedText: { color: colors.accent, fontSize: 13, fontWeight: '700' },
  ...
  action: { alignItems: 'center', borderRadius: 6, flex: 1, justifyContent: 'center', minHeight: 50 },
