...
const IMAGES: Record<string, ImageSourcePropType> = {
  ...
  'lamine-profile': require('./indices/lamine-profile.jpg'),
  ...
  'kylian-mbappe': require('./indices/kylian-mbappe.jpg'),
  ...
  'lebron-profile': require('./indices/lebron-profile.jpg'),
  'vinicius-junior': require('./indices/vinicius-junior.jpg'),
  'erling-haaland': require('./indices/erling-haaland.jpg'),
  'jude-bellingham': require('./indices/jude-bellingham.jpg'),
